...
import CreateProductFormComponent from './components/create-product-form-component/insertProductFormComponent'
  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/ProductCreate" element={<CreateProductFormComponent />} />
